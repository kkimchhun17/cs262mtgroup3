                ...
                <div class="w-100">
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            id="input-name" name="name" placeholder="food name" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <select
                            ...
                            <option value="rice-noodles" {{ old('category') == 'rice-noodles' ? 'selected' : '' }}>Rice
                                & Noodle Dishes</option>
                            <option value="soup" {{ old('category') == 'soup' ? 'selected' : '' }}>Soups & Curries
                            </option>
                            <option value="grilled" {{ old('category') == 'grilled' ? 'selected' : '' }}>Grilled &
                                Stir-Fried Dishes</option>
                            <option value="dessert" {{ old('category') == 'dessert' ? 'selected' : '' }}>Desserts &
                                Snacks</option>
                        </select>
                        @error('category')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-lg bg-light border-0 py-3 rounded-3 shadow-sm"
                                id="input-difficulty" name="difficulty">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number"
                                ...
                                id="input-duration" name="duration" min="1">
                        </div>
                    </div>
                </div>
    ...
    Object.keys(inputs).forEach(inputId => {
        ...
        if (inputEl && previewEl) {
            const updateValue = () => {
                ...
                } else if (inputId === 'input-rating') {
                    const rating = parseInt(inputEl.value || 5);
...
function updateRatingPreview(rating) {
    const preview = document.getElementById('preview-rating');
...
updateRatingPreview(selectedRating);
</script>
@endsection