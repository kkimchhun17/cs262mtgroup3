    ...
    <div class="page-hero bg-ink text-white py-5 px-4 px-lg-5">
      <div class="position-relative z-1" style="max-width: 600px;">
        ...
        <div class="d-flex gap-4 gap-md-5 mt-4">
          <div>
            <div class="font-serif fs-3 fw-semibold lh-1">{{ $totalDishes }}</div>
            <div class="text-white-50 small mt-1">Total dishes</div>
          </div>
          <div>
            <div class="font-serif fs-3 fw-semibold lh-1">{{ $totalCategories }}</div>
            <div class="text-white-50 small mt-1">Categories</div>
          </div>
